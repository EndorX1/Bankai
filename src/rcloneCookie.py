...
parser = argparse.ArgumentParser(prog="Bankai Cookie script", description="Handles the fetching of cookies from browsers and the writing of them to the rclone.conf file")
